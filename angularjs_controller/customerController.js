app.controller("customerCtrl", function ($scope,$http,$filter,$timeout,dateFilter,$rootScope,$mdDialog,MessageService,Entry,UserService) {
    ...
    $scope.students=UserService.query();
